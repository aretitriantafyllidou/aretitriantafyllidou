...
SELECT  Chinook.[dbo].Invoice.InvoiceID, InvoiceLineid, Chinook.[dbo].Track.Trackid,
Chinook.[dbo].Invoice.CustomerId, InvoiceDate, BillingAddress, BillingCity, BillingCountry,
BillingState, BillingPostalCode, Total, Chinook.[dbo].InvoiceLine.UnitPrice, Quantity 
