...
TRUNCATE TABLE [ChinookStaging].[dbo].[InvoiceDetails];

INSERT INTO [ChinookStaging].[dbo].[InvoiceDetails]
    (InvoiceLineid, InvoiceID, CustomerId, Trackid, UnitPrice, Quantity,InvoiceDate, Total)
SELECT 
    IL.InvoiceLineId, IL.InvoiceId, I.CustomerId, IL.TrackId, IL.UnitPrice, IL.Quantity, InvoiceDate, I.Total
FROM [Chinook].[dbo].[InvoiceLine] IL
INNER JOIN [Chinook].[dbo].[Invoice] I ON IL.InvoiceId = I.InvoiceId
WHERE I.CustomerId IS NOT NULL and I.InvoiceDate IS NOT NULL;
